...
HD_PWD='C:/Users/gcapo/Documents/CESE_docs/04 FPGA/TP/NCO_senoidal/Vivado_VIO/NCO senoidal VIO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seno_VIO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seno_VIO.tcl -notrace
