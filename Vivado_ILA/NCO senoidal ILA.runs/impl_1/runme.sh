...
HD_PWD='C:/Users/gcapo/Documents/CESE_docs/04 FPGA/TP/NCO_senoidal/Vivado_ILA/NCO senoidal ILA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log seno_VIO_ILA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source seno_VIO_ILA.tcl -notrace
