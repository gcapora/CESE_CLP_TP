...
HD_PWD='C:/Users/gcapo/Documents/CESE_docs/04 FPGA/TP/NCO_senoidal/Vivado_ILA/NCO senoidal ILA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seno_VIO_ILA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seno_VIO_ILA.tcl
